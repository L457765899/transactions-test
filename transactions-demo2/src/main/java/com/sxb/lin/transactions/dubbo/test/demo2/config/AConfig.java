...
@MapperScan(
    basePackages = "com.sxb.lin.transactions.dubbo.test.demo2.a.dao",
    sqlSessionFactoryRef = "sqlSessionFactory1"
)
@Configuration
public class AConfig {
	
	public final static String DB_DEMO2_A = "DB-demo2-a";
	...
	public DataSource dataSource1() throws SQLException{
        ...
        druidXADataSource.setUrl("jdbc:mysql://192.168.0.252:3306/demo2-a");
        druidXADataSource.setUsername("demo");
        druidXADataSource.setPassword("123456");
        
        AtomikosDataSourceBean atomikosDataSourceBean = new AtomikosDataSourceBean();
        atomikosDataSourceBean.setUniqueResourceName(DB_DEMO2_A);
    ...
    public SqlSessionFactoryBean sqlSessionFactory1(@Qualifier("dataSource1") DataSource ds1) throws IOException{
        ...
        bean.setMapperLocations(resolver.getResources("classpath:com/sxb/lin/transactions/dubbo/test/demo2/a/mapping/*.xml"));
        bean.setTransactionFactory(new XASpringManagedTransactionFactory(DB_DEMO2_A));
        return bean;
    }
}
