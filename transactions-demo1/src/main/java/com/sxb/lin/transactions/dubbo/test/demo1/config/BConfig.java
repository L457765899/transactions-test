...
@MapperScan(
    basePackages = "com.sxb.lin.transactions.dubbo.test.demo1.b.dao",
    sqlSessionFactoryRef = "sqlSessionFactory2"
)
@Configuration
public class BConfig {
	
	public final static String DB_DEMO1_B = "DB-demo1-b";
	...
	public DataSource dataSource2() throws SQLException{
        ...
        atomikosDataSourceBean.setUniqueResourceName(DB_DEMO1_B);
    ...
    public SqlSessionFactoryBean sqlSessionFactory2(@Qualifier("dataSource2") DataSource ds2) throws IOException{
        ...
        bean.setMapperLocations(resolver.getResources("classpath:com/sxb/lin/transactions/dubbo/test/demo1/b/mapping/*.xml"));
        bean.setTransactionFactory(new XASpringManagedTransactionFactory(DB_DEMO1_B));
        return bean;
    }
}
